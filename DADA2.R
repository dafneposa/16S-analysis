...
#title: DADA2 16S Processing ori1 Nudibranquios
...
path1_R1 <- "/home/dafpor/nudibranquios2/primer_removed_fastqs_2/R1"
path1_R2 <- "/home/dafpor/nudibranquios2/primer_removed_fastqs_2/R2"
...
sample.names <- sapply(strsplit(basename(fnFs), "_trimPrim"), `[`, 1)

##B) Set path to output DADA2 Clean FASTQ files
pathO1_R1="/home/dafpor/nudibranquios2/qcDD2_fastqs_2/R1"
pathO1_R2="/home/dafpor/nudibranquios2/qcDD2_fastqs_2/R2"
## Assign filenames for the filtered fastq.gz files
filtFs <- file.path(pathO1_R1, paste0(sample.names, "trimPrim_qcDD2_R1.fastq.gz"))
filtRs <- file.path(pathO1_R2, paste0(sample.names, "trimPrim_qcDD2_R2.fastq.gz"))
names(filtFs) <- sample.names
names(filtRs) <- sample.names

##C) Set path to output R_Objects directory
pathO2="/home/dafpor/nudibranquios2/tareas/tarea1/DADA2/R_Objects"
